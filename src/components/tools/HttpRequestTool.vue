...
<template>
  <header class="detail-header http-detail-header">
    ...
    <div class="header-actions http-header-actions">
      ...
      <button class="http-export-button" type="button" @click="exportWorkspace">导出</button>
