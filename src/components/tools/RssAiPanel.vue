  ...
  <aside class="rss-ai-panel">
    ...
    <div class="rss-ai-output">
      ...
      <div v-else class="rss-ai-result">
        ...
        <div class="rss-ai-markdown" v-html="renderedOutput"></div>
...
<style scoped>
.rss-ai-panel{display:flex;min-width:0;overflow:hidden;flex-direction:column;border:1px solid var(--color-border);background:var(--color-panel-translucent)}.rss-ai-panel>header{display:flex;min-height:58px;flex:0 0 auto;align-items:center;justify-content:space-between;padding:0 12px;border-bottom:1px solid var(--color-border);background:var(--color-bg-muted)}.rss-ai-title{display:flex;min-width:0;align-items:center;gap:9px}.rss-ai-title>span{display:grid;width:30px;height:30px;flex:0 0 auto;place-items:center;border-radius:8px;background:color-mix(in srgb,var(--color-accent) 14%,var(--color-bg-panel));color:var(--color-accent)}.rss-ai-title svg{width:19px;fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.6}.rss-ai-title div{display:grid;min-width:0;gap:3px}.rss-ai-title strong{font-size:11px}.rss-ai-title small{overflow:hidden;color:var(--color-text-muted);font:7px/1.2 "SFMono-Regular",Consolas,monospace;text-overflow:ellipsis;white-space:nowrap}.rss-ai-panel>header>button{width:28px;min-height:28px;padding:0;border:0;background:transparent;font-size:15px}.rss-ai-actions{display:grid;flex:0 0 auto;grid-template-columns:repeat(4,1fr);border-bottom:1px solid var(--color-border)}.rss-ai-actions button{min-width:0;min-height:38px;padding:5px 3px;border:0;border-right:1px solid var(--color-border);background:transparent;color:var(--color-text-muted);font-size:8px;white-space:nowrap}.rss-ai-actions button:last-child{border-right:0}.rss-ai-actions button.active{background:var(--color-panel-active);color:var(--color-accent);box-shadow:inset 0 -2px var(--color-accent)}.rss-ai-question{flex:0 0 auto;padding:10px 12px 0}.rss-ai-question textarea{box-sizing:border-box;width:100%;min-height:70px;resize:vertical;padding:9px 10px;border:1px solid var(--color-border);background:var(--color-input);color:var(--color-text-primary);font:9px/1.5 inherit}.rss-ai-output{min-height:0;flex:1 1 auto;overflow:auto}.rss-ai-state,.rss-ai-empty{display:grid;height:100%;min-height:220px;place-items:center;align-content:center;gap:8px;padding:24px;color:var(--color-text-muted);text-align:center}.rss-ai-state{grid-auto-flow:column}.rss-ai-empty>span{display:grid;width:42px;height:42px;place-items:center;border:1px solid var(--color-border);border-radius:12px;color:var(--color-accent);font-size:18px}.rss-ai-empty strong{color:var(--color-text-primary);font-size:11px}.rss-ai-empty p{max-width:250px;margin:0;font-size:8px;line-height:1.6}.rss-ai-result{padding:20px 18px 28px}.rss-ai-result-meta{display:flex;align-items:center;gap:7px;margin-bottom:14px;color:var(--color-text-muted);font:7px/1.2 "SFMono-Regular",Consolas,monospace}.rss-ai-result-meta b{padding:3px 5px;border:1px solid var(--color-warning);border-radius:8px;color:var(--color-warning);font-weight:500}.rss-ai-markdown{color:var(--color-text-secondary);font-size:10px;line-height:1.78;word-break:break-word}.rss-ai-markdown :deep(p){margin:0 0 12px}.rss-ai-markdown :deep(p:last-child),.rss-ai-markdown :deep(ul:last-child),.rss-ai-markdown :deep(ol:last-child),.rss-ai-markdown :deep(pre:last-child),.rss-ai-markdown :deep(blockquote:last-child){margin-bottom:0}.rss-ai-markdown :deep(h2),.rss-ai-markdown :deep(h3),.rss-ai-markdown :deep(h4),.rss-ai-markdown :deep(h5){margin:18px 0 8px;color:var(--color-text-primary);line-height:1.35}.rss-ai-markdown :deep(h2){font-size:14px}.rss-ai-markdown :deep(h3){font-size:12px}.rss-ai-markdown :deep(h4),.rss-ai-markdown :deep(h5){font-size:11px}.rss-ai-markdown :deep(ul),.rss-ai-markdown :deep(ol){margin:0 0 14px;padding-left:20px}.rss-ai-markdown :deep(li){margin:5px 0;padding-left:2px}.rss-ai-markdown :deep(strong){color:var(--color-text-primary);font-weight:700}.rss-ai-markdown :deep(a){color:var(--color-accent);text-decoration:none}.rss-ai-markdown :deep(a:hover){text-decoration:underline}.rss-ai-markdown :deep(code){padding:2px 4px;border:1px solid var(--color-border);background:var(--color-bg-muted);font:8px/1.5 "SFMono-Regular",Consolas,monospace}.rss-ai-markdown :deep(pre){margin:10px 0 14px;overflow:auto;padding:11px 12px;border:1px solid var(--color-border);background:var(--terminal-bg);color:var(--terminal-fg)}.rss-ai-markdown :deep(pre code){padding:0;border:0;background:transparent;color:inherit}.rss-ai-markdown :deep(blockquote){margin:10px 0 14px;padding:7px 10px;border-left:3px solid var(--color-accent);background:var(--color-bg-muted);color:var(--color-text-secondary)}.rss-ai-markdown :deep(hr){margin:16px 0;border:0;border-top:1px solid var(--color-border)}.rss-ai-cursor{display:inline-block;width:6px;height:12px;margin-left:2px;background:var(--color-accent);animation:rss-ai-blink 800ms steps(1) infinite}.rss-ai-error{display:flex;flex:0 0 auto;gap:8px;margin:0 12px 10px;padding:9px 10px;border:1px solid color-mix(in srgb,var(--color-danger) 45%,var(--color-border));background:var(--color-danger-surface);color:var(--color-danger-text)}.rss-ai-error span{font-weight:700}.rss-ai-error p{margin:0;font-size:8px;line-height:1.5}.rss-ai-panel>footer{display:grid;flex:0 0 auto;gap:8px;padding:10px 12px;border-top:1px solid var(--color-border);background:var(--color-bg-muted)}.rss-ai-panel>footer>p{margin:0;color:var(--color-text-muted);font-size:7px;line-height:1.4}.rss-ai-panel>footer>div{display:flex;flex-wrap:wrap;gap:6px}.rss-ai-panel>footer>div>span{flex:1}.rss-ai-panel button{display:inline-flex;min-height:30px;align-items:center;justify-content:center;padding:6px 9px;border:1px solid var(--color-border-strong);background:var(--color-bg-panel);color:var(--color-text-primary);font-size:8px;cursor:pointer;white-space:nowrap}.rss-ai-panel button.primary{border-color:var(--color-control-primary);background:var(--color-control-primary);color:#fff}.rss-ai-stop{border-color:var(--color-danger-text)!important;color:var(--color-danger-text)!important}@keyframes rss-ai-blink{50%{opacity:0}}
</style>
